...
import { loginuser, logoutuser, registeruser,refreshaccesstoken, changecurrentpassword, getcurrentuser } from "../controllers/user.controllers.js";
...
router.route("/update-account").patch(verifyJWT,up)
